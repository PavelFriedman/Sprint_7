...
class TestCourierLogin:
    ...
    def test_courier_login_success(self):
        ...
        # Можно проверить наличие ключа "id" в JSON-ответе
    ...
    @allure.description('Передаются наборы данных с несуществующим логином или неверным паролем. '
    ...
    @allure.title('Проверка получения ошибки аутентификации курьера с пустым логином или паролем')
    @allure.description('Передаются наборы данных с пустым логином или пустым паролем. '
                        'Проверяются код и тело ответа.')
